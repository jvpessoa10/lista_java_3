...
public class CarroLuxo extends Carro {
    ...
    public CarroLuxo(boolean temArCondicionado, int nDePassageiros, TipoDeCombustivel tipoDeCombustivel, Double valorDaDiaria, boolean podeSerAluagadoComQuilometragemLivre, String placa, Date anoDeFabricação, Double quilometragemRodadaTotal) {
